...
import com.github.csaba.todo.repo.PasswordRepo
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todoButton!!.setOnClickListener(View.OnClickListener { openTodo() })

        secretButton = findViewById(R.id.secret_button)
        secretButton!!.setOnClickListener(View.OnClickListener { secretTodo() })

        changePassButton = findViewById(R.id.change_password_button)
        changePassButton!!.setOnClickListener(View.OnClickListener { changePass() })
    }
